...
/// Checks generated contracts, or rewrites them when `check` is false.
///
/// # Errors
///
/// Returns an error if contract inputs are invalid, artifact I/O fails, or
/// check mode detects generated bytes that differ from the committed files.
